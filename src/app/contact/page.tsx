export default function ContactPage() {
  return (
    <div className="pt-32 pb-20 container mx-auto px-6 text-center min-h-[70vh]">
      <h1 className="text-5xl font-outfit font-bold mb-6">Contact <span className="gradient-text">Us</span></h1>
      <p className="text-gray-400 max-w-2xl mx-auto mb-8">Reach out to our admissions team for customized queries.</p>
      <div className="bg-white/5 border border-white/10 rounded-2xl p-8 max-w-lg mx-auto backdrop-blur-md">
        <h2 className="text-2xl font-bold font-outfit mb-4 text-white">Contact Info</h2>
